...
export const getByCategory = (cat) => {
  return listadoProductos.filter((e) => e.category === cat);
};

export const getById = (id) => {
    return listadoProductos.find((e) => e.id == id ); //Si es estrictamente igual se rompe porque useParams solo interpreta Strings 
}
